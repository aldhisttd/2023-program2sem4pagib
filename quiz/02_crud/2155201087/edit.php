...
<body>
    ...
    $nomortagihan  = $_REQUEST['nomor tagihan'];
    // koneksi
    include "action/koneksi.php";
    // jalankan query select dengan condition 
    $q = mysqli_query($koneksi, "SELECT * FROM pembayaran WHERE nim='$nomortagihan'");
    ...
    <form action="action/ac_edit.php" method="POST" enctype="multipart/form-data">
        ...
        <table>
            <tr>
                ...
                <td>:</td>
                <td>
                    <input readonly type="text" name="nomor tagihan" value="<?php echo $ary['nomor tagihan'] ?>">
                </td>
            </tr>
            <tr>
                <td>Tanggal</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <textarea name="jenis tagihan" cols="30" rows="5"><?php echo $ary['jenis tagihan'] ?></textarea>
                </td>
            </tr>
            <tr>
                <td>Nominal</td>
