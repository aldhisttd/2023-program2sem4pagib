...
<body>
    ...
    $q = mysqli_query($koneksi, "SELECT * FROM buku WHERE isbn='$isbn'");
    ...
    <form action="action/ac_edit.php" method="POST" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                        <select input type="text" name="kategori" value="<?php echo $ary['kategori'] ?>">
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="file" name="file" value="<?php echo $ary['file_ebook'] ?>">
                </td>
            </tr>
            <tr>
                <td></td>
