...
<body>
    ...
    $q = mysqli_query($koneksi, "SELECT * FROM ganjil WHERE no_tagihan='$no_tagihan'");
    ...
    <form action="action/ac_edit.php" method="POST" enctype="multipart/form-data">
        ...
        <table>
            <tr>
                ...
                <td>:</td>
                <td>
                    <input readonly type="text" name="no_tagihan" value="<?php echo $ary['no_tagihan'] ?>">
                </td>
            </tr>
            <tr>
                <td>Tanggal</td>
            ...
            <tr>
                ...
                <td>
                    <br><br>
                    <button type="submit"><font color=" blue">Update Data</font></button>
                </td>
            </tr>
        </table>
